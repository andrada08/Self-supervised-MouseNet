...
PATH_CPC_mousenet = "/nfs/gatsbystor/ammarica/SimCLR-with-MouseNet/Checkpoints_simclr_2_gpu_b_1024_lr_05/model_best.pth.tar"
...
R = compare_reps(model_type = [('CPC','mousenet', PATH_CPC_mousenet)], 
             ...
             path_fig = '/nfs/gatsbystor/ammarica/RSA/figs_simclr/',
             compare_models = True,
