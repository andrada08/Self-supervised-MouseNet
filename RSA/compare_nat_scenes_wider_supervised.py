...
PATH_CPC_mousenet = "/nfs/gatsbystor/ammarica/SimSiam-with-MouseNet/Checkpoints_supervised_wide_b_1024_lr_05_new/model_best.pth.tar"
...
R = compare_reps(model_type = [('CPC','mousenet', PATH_CPC_mousenet)], 
             ...
             path_fig = '/nfs/gatsbystor/ammarica/RSA/figs_wider_supervised/',
             compare_models = True,
