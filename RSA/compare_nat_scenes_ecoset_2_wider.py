...
PATH_CPC_mousenet = "/nfs/gatsbystor/ammarica/Ecoset/Checkpoints_supervised_2_wider_b_1024_lr_015/model_best.pth.tar"
...
R = compare_reps(model_type = [('CPC','mousenet', PATH_CPC_mousenet)], 
             ...
             path_fig = '/nfs/gatsbystor/ammarica/RSA/figs_ecoset_2_wider/',
             compare_models = True,
