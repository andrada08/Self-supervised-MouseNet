...
PATH_CPC_mousenet = "/nfs/gatsbystor/ammarica/Supervised/Checkpoints_supervised_half_width_b_1024_lr_05/model_best.pth.tar"
...
R = compare_reps(model_type = [('CPC','mousenet', PATH_CPC_mousenet)], 
             ...
             path_fig = '/nfs/gatsbystor/ammarica/RSA/figs_half_width_supervised/',
             compare_models = True,
