...
PATH_CPC_mousenet = "/nfs/gatsbystor/ammarica/Same_acc_sup/Checkpoints_supervised_b_1024_lr_01/model_best.pth.tar"
...
R = compare_reps(model_type = [('CPC','mousenet', PATH_CPC_mousenet)], 
             ...
             path_fig = '/nfs/gatsbystor/ammarica/RSA/figs_sup_same_acc/',
             compare_models = True,
